...
const Contact = () => {
    ...
    const handleContactSubmit = event => {
        ...
        const whatsappLink = `https://wa.me/+6281278732817?text=Hello, my name is ${formData.name}. My email is ${formData.email} and my phone number is ${formData.phone}. Here is my message: ${formData.message}`;
